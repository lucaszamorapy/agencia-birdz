  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 mt-10 lg:grid lg:grid-cols-4">
      {data["o-que-fazemos"].map((item, index) => (
        <div className=" bg-blackBirdz flex flex-col items-center justify-center  h-[250px] rounded-lg shadow-md hover:scale-105 transition-transform duration-300 ease-in-out" key={index}>
